...
#############################################
# Pull pipeline assets first so env files exist
#############################################
...
#############################################
# Prebuild envs that have already failed or look risky
#############################################
...
# FASTX Toolkit used by FORMAT_MATURE
...
# samtools/sort used by BAM_STATS_MATURE
